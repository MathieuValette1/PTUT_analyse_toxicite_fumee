...
def traceur_pm2_5_mazamet():
    ...
    traceur_mazametSalePM2_5.set_op_mazamet(op_mazamet)
    ...
    traceur_mazametProprePM2_5.set_op_mazamet(op_mazamet)
    ...
    traceur_mazametRemisePM2_5.set_op_mazamet(op_mazamet)
